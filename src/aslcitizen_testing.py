...
video_base_path = './ASL_Citizen/videos/'
train_file = './ASL_Citizen/splits/train.csv'
test_file = './ASL_Citizen/splits/test.csv'
...
test_loader = torch.utils.data.DataLoader(test_ds, batch_size=5, shuffle=True, num_workers=2, pin_memory=True)
